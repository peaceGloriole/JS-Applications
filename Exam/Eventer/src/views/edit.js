import { getEventsById, updateEvent } from '../data/events.js';
...
<section id="edit">
  <div class="form">
    ...
    <form class="edit-form" @submit=${onEdit}>
      ...
      <textarea id="event-description" name="description" placeholder="Description" .value=${event.description} rows="5" cols="50"></textarea>
